...
async function runOptimizer() {
    ...
    const summarized = summarizeSession(sessions)
    const suggestion = await suggestUIChanges(summarized)
  
    console.log('LLM Suggestion:\n', suggestion)
    await saveSuggestionToSupabase(suggestion)
  }
